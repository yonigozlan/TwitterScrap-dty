  ...
  getTweets(trend : any, e : any){
    ...
    console.log("called")
      ...
      console.log(data);
        ...
        this.map.getSource('tweets').setData(this.tweetsMarker);
        // console.log(this.countryCodes[data.place.country_code.toLowerCase()]);
    ...
    this.api.getTrendsMapHistory(params)
      .subscribe(
        (tweets : any) => {
          ...
          // this.trends = tempTrends.slice(0,10)
